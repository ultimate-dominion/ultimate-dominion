...
5. **Test on beta first.** Beta world address: `0xD2051EB4F5001d46c11F928BD6578Bd5f7e028A3`. Deploy and validate there before touching production. See `docs/architecture/` for deployment guides.
