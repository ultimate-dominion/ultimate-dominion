...
5. **Test on beta first.** Beta world address: `0xDc34AC3b06fa0ed899696A72B7706369864E5678`. Deploy and validate there before touching production. See `docs/architecture/` for deployment guides.
