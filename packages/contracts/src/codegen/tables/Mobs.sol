...
library Mobs {
    ...
    function decodeDynamic(EncodedLengths _encodedLengths, bytes memory _blob)
        internal
        pure
        returns (bytes memory mobStats, string memory mobMetadata)
    {
        uint256 _start;
        uint256 _end;
        unchecked {
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (MobsData memory _table)
    {
     ...
     */
    function encodeLengths(bytes memory mobStats, string memory mobMetadata)
        internal
        pure
     ...
     */
    function encode(MobType mobType, bytes memory mobStats, string memory mobMetadata)
        internal
        pure
