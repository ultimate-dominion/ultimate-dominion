...
library CharacterEquipment {
    ...
    function getItemEquippedSpells(bytes32 characterId, uint256 _index) internal view returns (uint256) {
        ...
        unchecked {
            bytes memory _blob =
                StoreSwitch.getDynamicFieldSlice(_tableId, _keyTuple, 2, _index * 32, (_index + 1) * 32);
            return (uint256(bytes32(_blob)));
        }
    }
    ...
    function updateEquippedSpells(bytes32 characterId, uint256 _index, uint256 _element) internal {
        ...
        unchecked {
            bytes memory _encoded = abi.encodePacked((_element));
            StoreSwitch.spliceDynamicData(
                _tableId, _keyTuple, 2, uint40(_index * 32), uint40(_encoded.length), _encoded
            );
        }
    }
     ...
     * @notice Get equippedConsumables.
     */
    function _getEquippedConsumables(bytes32 characterId)
        internal
        view
        returns (uint256[] memory equippedConsumables)
    {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = characterId;
    ...
    function getItemEquippedConsumables(bytes32 characterId, uint256 _index) internal view returns (uint256) {
        ...
        unchecked {
            bytes memory _blob =
                StoreSwitch.getDynamicFieldSlice(_tableId, _keyTuple, 3, _index * 32, (_index + 1) * 32);
            return (uint256(bytes32(_blob)));
        }
    }
    ...
    function updateEquippedConsumables(bytes32 characterId, uint256 _index, uint256 _element) internal {
        ...
        unchecked {
            bytes memory _encoded = abi.encodePacked((_element));
            StoreSwitch.spliceDynamicData(
                _tableId, _keyTuple, 3, uint40(_index * 32), uint40(_encoded.length), _encoded
            );
        }
    }
    ...
    function set(
        ...
        EncodedLengths _encodedLengths =
            encodeLengths(equippedArmor, equippedWeapons, equippedSpells, equippedConsumables);
    ...
    function set(bytes32 characterId, CharacterEquipmentData memory _table) internal {
        bytes memory _staticData =
            encodeStatic(_table.strBonus, _table.agiBonus, _table.intBonus, _table.hpBonus, _table.armor);

        EncodedLengths _encodedLengths = encodeLengths(
            _table.equippedArmor, _table.equippedWeapons, _table.equippedSpells, _table.equippedConsumables
        );
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (int256 strBonus, int256 agiBonus, int256 intBonus, int256 hpBonus, int256 armor)
    {
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (CharacterEquipmentData memory _table)
    {
     ...
     */
    function encodeStatic(int256 strBonus, int256 agiBonus, int256 intBonus, int256 hpBonus, int256 armor)
        internal
        pure
