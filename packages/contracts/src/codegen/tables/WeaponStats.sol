...
library WeaponStats {
    ...
    function set(
        ...
        bytes memory _staticData =
            encodeStatic(agiModifier, intModifier, hpModifier, maxDamage, minDamage, minLevel, strModifier);
    ...
    function decodeDynamic(EncodedLengths _encodedLengths, bytes memory _blob)
        internal
        pure
        returns (bytes32[] memory effects)
    {
        uint256 _start;
        uint256 _end;
        unchecked {
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (WeaponStatsData memory _table)
    {
        (
            _table.agiModifier,
            _table.intModifier,
