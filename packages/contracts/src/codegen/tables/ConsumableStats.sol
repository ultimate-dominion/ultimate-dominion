...
library ConsumableStats {
     ...
     */
    function set(uint256 itemId, int256 minDamage, int256 maxDamage, uint256 minLevel, bytes32[] memory effects)
        internal
    {
     ...
     * @notice Set the full data using individual values.
     */
    function _set(uint256 itemId, int256 minDamage, int256 maxDamage, uint256 minLevel, bytes32[] memory effects)
        internal
    {
        bytes memory _staticData = encodeStatic(minDamage, maxDamage, minLevel);
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (int256 minDamage, int256 maxDamage, uint256 minLevel)
    {
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (ConsumableStatsData memory _table)
    {
     ...
     */
    function encode(int256 minDamage, int256 maxDamage, uint256 minLevel, bytes32[] memory effects)
        internal
        pure
