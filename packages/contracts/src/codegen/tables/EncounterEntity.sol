...
library EncounterEntity {
     ...
     */
    function getAppliedStatusEffects(bytes32 encounterEntityId)
        internal
        view
        returns (bytes32[] memory appliedStatusEffects)
    {
        bytes32[] memory _keyTuple = new bytes32[](1);
        _keyTuple[0] = encounterEntityId;
     ...
     * @notice Get appliedStatusEffects.
     */
    function _getAppliedStatusEffects(bytes32 encounterEntityId)
        internal
        view
        returns (bytes32[] memory appliedStatusEffects)
    {
     ...
     */
    function set(bytes32 encounterEntityId, bytes32 encounterId, bool died, bytes32[] memory appliedStatusEffects)
        internal
    {
     ...
     * @notice Set the full data using individual values.
     */
    function _set(bytes32 encounterEntityId, bytes32 encounterId, bool died, bytes32[] memory appliedStatusEffects)
        internal
    {
        bytes memory _staticData = encodeStatic(encounterId, died);
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (EncounterEntityData memory _table)
    {
     ...
     */
    function encodeLengths(bytes32[] memory appliedStatusEffects)
        internal
        pure
     ...
     */
    function encode(bytes32 encounterId, bool died, bytes32[] memory appliedStatusEffects)
        internal
        pure
