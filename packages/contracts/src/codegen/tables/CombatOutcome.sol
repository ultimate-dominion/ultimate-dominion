...
library CombatOutcome {
    ...
    FieldLayout constant _fieldLayout =
        FieldLayout.wrap(0x0061040120012020000000000000000000000000000000000000000000000000);

    // Hex-encoded key schema of (bytes32)
    Schema constant _keySchema = Schema.wrap(0x002001005f000000000000000000000000000000000000000000000000000000);
    // Hex-encoded value schema of (uint256, bool, uint256, uint256, uint256[])
    Schema constant _valueSchema = Schema.wrap(0x006104011f601f1f810000000000000000000000000000000000000000000000);
    ...
    function set(bytes32 encounterId, CombatOutcomeData memory _table) internal {
        bytes memory _staticData =
            encodeStatic(_table.endTime, _table.attackersWin, _table.expDropped, _table.goldDropped);
    ...
    function decodeStatic(bytes memory _blob)
        internal
        pure
        returns (uint256 endTime, bool attackersWin, uint256 expDropped, uint256 goldDropped)
    {
    ...
    function decodeDynamic(EncodedLengths _encodedLengths, bytes memory _blob)
        internal
        pure
        returns (uint256[] memory itemsDropped)
    {
        uint256 _start;
        uint256 _end;
        unchecked {
     ...
     */
    function encodeStatic(uint256 endTime, bool attackersWin, uint256 expDropped, uint256 goldDropped)
        internal
        pure
