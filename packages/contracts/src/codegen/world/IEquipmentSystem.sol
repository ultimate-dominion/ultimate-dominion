...
import { AdjustedCombatStats, WeaponStats, ArmorStats, SpellStats } from "@interfaces/Structs.sol";
...
interface IEquipmentSystem {
  ...
  function UD__getSpellStats(uint256 itemId) external view returns (SpellStats memory _spellStats);
}
