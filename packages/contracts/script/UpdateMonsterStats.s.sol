...
contract UpdateMonsterStats is Script {
    function run(address worldAddress) external {
        ...
        _updateMob(1, MonsterStats({
            ...
            experience: 2, hitPoints: 12, intelligence: 3,
        ...
        _updateMob(2, MonsterStats({
            ...
            experience: 4, hitPoints: 14, intelligence: 9,
        ...
        _updateMob(3, MonsterStats({
            ...
            experience: 6, hitPoints: 22, intelligence: 4,
        ...
        _updateMob(4, MonsterStats({
            ...
            experience: 8, hitPoints: 20, intelligence: 12,
        ...
        _updateMob(5, MonsterStats({
            ...
            experience: 10, hitPoints: 32, intelligence: 6,
        ...
        _updateMob(6, MonsterStats({
            ...
            experience: 13, hitPoints: 28, intelligence: 7,
        ...
        _updateMob(7, MonsterStats({
            ...
            experience: 20, hitPoints: 32, intelligence: 17,
        ...
        _updateMob(8, MonsterStats({
            ...
            experience: 25, hitPoints: 48, intelligence: 9,
        ...
        _updateMob(9, MonsterStats({
            ...
            experience: 33, hitPoints: 42, intelligence: 10,
        ...
        _updateMob(10, MonsterStats({
            ...
            experience: 65, hitPoints: 70, intelligence: 20,
