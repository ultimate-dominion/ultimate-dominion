...
contract UpdateMonsterStats is Script {
    function run(address worldAddress) external {
        ...
        _updateMob(1, MonsterStats({
            ...
            experience: 2, hasBossAI: false, hitPoints: 12, intelligence: 3,
        ...
        _updateMob(2, MonsterStats({
            ...
            experience: 4, hasBossAI: false, hitPoints: 14, intelligence: 9,
        ...
        _updateMob(3, MonsterStats({
            ...
            experience: 6, hasBossAI: false, hitPoints: 22, intelligence: 4,
        ...
        _updateMob(4, MonsterStats({
            ...
            experience: 8, hasBossAI: false, hitPoints: 20, intelligence: 12,
        ...
        _updateMob(5, MonsterStats({
            ...
            experience: 10, hasBossAI: false, hitPoints: 32, intelligence: 6,
        ...
        _updateMob(6, MonsterStats({
            ...
            experience: 13, hasBossAI: false, hitPoints: 28, intelligence: 7,
        ...
        _updateMob(7, MonsterStats({
            ...
            experience: 20, hasBossAI: false, hitPoints: 32, intelligence: 17,
        ...
        _updateMob(8, MonsterStats({
            ...
            experience: 25, hasBossAI: false, hitPoints: 48, intelligence: 9,
        ...
        _updateMob(9, MonsterStats({
            ...
            experience: 33, hasBossAI: false, hitPoints: 42, intelligence: 10,
        ...
        _updateMob(10, MonsterStats({
            ...
            experience: 65, hasBossAI: false, hitPoints: 70, intelligence: 20,
