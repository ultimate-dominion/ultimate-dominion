...
const WEAPONS_TO_FIX: WeaponFix[] = [
  ...
  // --- Monster magic weapons (single-effect, physical → magic) ---
  {
    name: 'Dark Magic (monster)',
    metadataUri: 'weapon:monster_dark_magic',
    dropChance: 0n,
    price: 0n,
    rarity: 0n,
    template: {
  ...
  {
    name: 'Elemental Burst (monster)',
    metadataUri: 'weapon:monster_elemental_burst',
    dropChance: 0n,
    price: 0n,
    rarity: 0n,
    template: {
...
const MULTI_EFFECT_WEAPONS: MultiEffectWeaponFix[] = [
  ...
  {
    name: 'Petrifying Gaze (monster)',
    metadataUri: 'weapon:basilisk_gaze',
    dropChance: 0n,
    price: 0n,
    rarity: 0n,
    template: {
