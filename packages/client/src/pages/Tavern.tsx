...
const TavernCard = ({
  ...
  return (
    <Link {...linkProps} _hover={{ textDecoration: 'none' }} display="block">
      <Box
        bg="#1C1814"
        border="1px solid"
    ...
    <VStack align="stretch" spacing={3}>
      {items.map((item, i) => (
        <HStack
          ...
          align="flex-start"
          borderBottom={
            i < items.length - 1 ? '1px solid rgba(58,50,40,0.3)' : 'none'
          }
          pb={i < items.length - 1 ? 3 : 0}
          spacing={3}
        >
          <Text
            color="rgba(200,122,42,0.4)"
            fontSize="14px"
            fontWeight={600}
            mt="2px"
          >
      ...
      >
        ...
        <Box mt={{ base: 6, md: 8 }} w="100%">
          <Bulletin
            ...
            items={[
              {
                text: t('tavern.boardItem1'),
                detail: t('tavern.boardDetail1'),
              },
              {
                text: t('tavern.boardItem2'),
                detail: t('tavern.boardDetail2'),
              },
              {
                text: t('tavern.boardItem3'),
                detail: t('tavern.boardDetail3'),
              },
              {
                text: t('tavern.boardItem4'),
                detail: t('tavern.boardDetail4'),
              },
            ]}
          />
        </Box>
