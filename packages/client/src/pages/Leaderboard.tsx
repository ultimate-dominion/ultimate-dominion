...
export const Leaderboard = (): JSX.Element => {
  ...
  return (
    <Box>
      <Box border="solid 6px #1A244E">
        <VStack border="solid 2px #070D2A">
          <Box
            boxShadow="-4px 0 0 rgba(0, 0, 0, .2);"
            background="linear-gradient(225deg, transparent 30px, #0C1539 10px)"
            display="table"
            height="66px"
            padding="20px"
            position="relative"
          ...
          >
            ...
            <HStack px={3}>
              <Button
                ...
                dropShadow="-10px -10px 20px 0px #54545440, 5px 5px 10px 0px #54545480;"
              ...
              <Button
                backgroundColor="#BAC2CA"
                dropShadow="box-shadow: -10px -10px 20px 0px rgba(84, 84, 84, 0.25); box-shadow: 5px 5px 10px 0px rgba(84, 84, 84, 0.5);"
                leftIcon={
                  <Icon>
                    <svg
                      width="24"
