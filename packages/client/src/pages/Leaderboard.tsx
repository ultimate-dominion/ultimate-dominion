      ...
      <VStack>
        ...
        <VStack gap={3} overflowX="auto" w="100%">
          <Box
            ...
            h="5px"
            w="100%"
            boxShadow="-5px -5px 10px 0px #B3B9BE inset, box-shadow: 5px 5px 10px 0px #949CA380 inset, box-shadow: 2px 2px 4px 0px #88919980 inset, box-shadow: 0px 0px 4px 0px #545454 inset"
          ></Box>
          {entries.length > 0 ? (
