    ...
    >
      ...
      <VStack fontWeight={500} maxW="800px" spacing={6} textAlign="center">
        <Text size={{ base: 'xs', sm: 'sm', md: 'md' }}>
          ...
          beneath you offers no comfort. Glimpses of blood and bruises on your
          body only deepen the mystery, painting a silent story of unseen
          struggles.
        </Text>
        <Text size={{ base: 'xs', sm: 'sm', md: 'md' }}>
        ...
        <Text size={{ base: 'xs', sm: 'sm', md: 'md' }}>
          ...
          discovery. Gathering your strength, you rise, the weight of
