import { Box, HStack, keyframes, Link, Text, VStack } from '@chakra-ui/react';
...
export const LandingPage = (): JSX.Element => {
  ...
  return (
    <Box minH="100vh" px={{ base: 2, sm: 12, md: 20 }} py={{ base: 4, lg: 8 }}>
      ...
      >
        <Wordmark fontSize={{ base: '25px', sm: '34px', md: '40px' }} />
      </Box>
