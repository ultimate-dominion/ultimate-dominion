...
export const MONSTER_TEMPLATES_REDUX: MonsterTemplate[] = [
  ...
  { id: 'redux-goblin', name: 'Goblin', gridWidth: 7, gridHeight: 7, dynamic: true, monsterClass: 0, level: 3, atmosphere: { r: 96, g: 120, b: 48, intensity: 0.10 },
  ...
  { id: 'redux-skeleton', name: 'Skeleton', gridWidth: 7, gridHeight: 7, dynamic: true, monsterClass: 0, level: 5, atmosphere: { r: 96, g: 156, b: 70, intensity: 0.12 },
    draw: makeGLBDrawFn('/models/creatures/skeleton.glb', 7, 7, drawSkeletonRedux) },
  { id: 'redux-goblin-shaman', name: 'Goblin Shaman', gridWidth: 7, gridHeight: 7, dynamic: true, monsterClass: 1, level: 6, atmosphere: { r: 106, g: 70, b: 164, intensity: 0.12 },
    draw: makeGLBDrawFn('/models/creatures/goblin-shaman.glb', 7, 7, drawGoblinShamanRedux) },
  { id: 'redux-gelatinous-ooze', name: 'Gelatinous Ooze', gridWidth: 10, gridHeight: 14, dynamic: true, monsterClass: 2, level: 7, atmosphere: { r: 66, g: 182, b: 56, intensity: 0.12 },
    draw: makeGLBDrawFn('/models/creatures/gelatinous-ooze.glb', 10, 14, drawGelatinousOozeRedux) },
  { id: 'redux-bugbear', name: 'Bugbear', gridWidth: 7, gridHeight: 7, dynamic: true, monsterClass: 0, level: 8, atmosphere: { r: 172, g: 138, b: 72, intensity: 0.10 },
  ...
  { id: 'redux-hook-horror', name: 'Hook Horror', gridWidth: 14, gridHeight: 12, dynamic: true, monsterClass: 2, level: 10, atmosphere: { r: 136, g: 82, b: 178, intensity: 0.12 },
    draw: makeGLBDrawFn('/models/creatures/hook-horror.glb', 14, 12, drawDuskDrakeRedux) },
  { id: 'redux-basilisk', name: 'Basilisk', gridWidth: 26, gridHeight: 9, dynamic: true, monsterClass: 0, level: 12, isBoss: true, atmosphere: { r: 52, g: 86, b: 36, intensity: 0.10 }, renderOverrides: { gamma: 0.72, ambient: 0.45, brightnessBoost: 1.15, charDensityFloor: 0.14 },
