...
export function serializeRow(row) {
    ...
    for (const [k, v] of Object.entries(row)) {
        ...
        if (k === '__key_bytes' || k === '__last_updated_block_number')
            continue;
...
export function extractKeyBytes(row) {
...
export function pgNameToMudName(pgLogical) {
 ...
 */
export function resolveResourceName(resourceName) {
...
export function fixAbbreviations(name) {
    let result = name;
