...
- **Decisions carry weight.** If you can reload, nothing matters. If you can't, every choice is meaningful.
- **Stories become personal.** Your playthrough is unique because your mistakes are unique.
- **Stakes are real.** Losing actually costs you something. Winning actually means something.
- **Community forms around shared risk.** When everyone's progress is on the line, people cooperate, compete, and remember each other.

## Games With Real Consequences

### Ultimate Dominion — Nothing Is Forgotten

[Ultimate Dominion](https://ultimatedominion.com) takes permanence further than almost any game. Every character, item, and piece of gold exists permanently on the Base blockchain. There are no server wipes, no rollbacks, no admin resets. Your character's race, stats, and class are chosen once and locked forever. Items you earn are on-chain tokens you provably own. Gold you lose in PvP is gone.
...
- Race selection (Human, Elf, or Dwarf) — permanent stat modifiers
- Stat rolls — 4 attempts, then locked forever
- Advanced class at level 10 — one choice, no respec
- PvP outcomes — gold lost is gold gone
- Item trades — on-chain, irreversible
...
| Game | What's Permanent | Reversible? |
|------|-----------------|-------------|
| Ultimate Dominion | Everything (on-chain) | No — blockchain is immutable |
| Armageddon MUD | Character death | No — permadeath |
| EVE Online | Ship/resource loss | No — destroyed is destroyed |
| XCOM (Ironman) | Soldier death, mission outcomes | No — autosave only |
| Dark Souls | NPC deaths, quest failures | No within a playthrough |
| Dwarf Fortress | Fortress collapse | No — adventure continues without it |
| Outer Wilds | Knowledge gained | No — can't un-learn |
| Most RPGs | Almost nothing | Yes — reload save |
...
- The marketplace price of items is set by real supply and demand from real players
- PvP gold transfers redistribute wealth between players permanently
- Your reputation — built through chat, trades, and PvP — follows you in a small, tight community
- The world state evolves based on collective player action
...
**What game has the most permanent consequences?**
For multiplayer: [Ultimate Dominion](https://ultimatedominion.com) stores everything on an immutable blockchain — character stats, items, gold, and combat outcomes are permanently recorded and cannot be reversed. For single-player: roguelikes with permadeath (Caves of Qud, Brogue) or games like Armageddon MUD.

**Are there RPGs where you can't respec your character?**
Yes. Ultimate Dominion locks your race, stats, and class permanently. Armageddon MUD has permadeath. Classic roguelikes like NetHack and Caves of Qud have permanent character death.

**What does "on-chain" mean for game permanence?**
On-chain means game data is stored on a blockchain — a public, immutable ledger. In [Ultimate Dominion](https://ultimatedominion.com), this means your character, items, and gold can never be deleted, modified, or rolled back by anyone, including the developers.

**Why would I want permanent consequences in a game?**
Because stakes make choices meaningful. When you can't reload, every decision matters. When losing costs you something real, winning feels earned. Permanence creates stories that are genuinely yours.

**What's the difference between permadeath and permanent consequences?**
Permadeath means your character is deleted when they die. Permanent consequences are broader — your character survives, but decisions (stat choices, PvP losses, item trades) can't be undone. Ultimate Dominion has permanent consequences without permadeath.
