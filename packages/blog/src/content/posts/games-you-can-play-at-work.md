...
[Ultimate Dominion](https://ultimatedominion.com) checks every box: text-based (no graphics to explain), turn-based (fight a monster between code reviews), browser-based (just a URL), persistent (on-chain saves), and completely silent.

## Frequently Asked Questions

**What is the best game to play at work?**
For ongoing engagement: [Ultimate Dominion](https://ultimatedominion.com) — a text-based RPG you can play in 2-minute bursts between tasks. For idle play: Melvor Idle. For daily quick play: Wordle. For long-form strategy: Neptune's Pride.

**Can my IT department see that I'm playing a game?**
If they're monitoring traffic, yes. Browser-based text games generate minimal, nondescript traffic though. Use your judgment.

**Are there multiplayer games I can play at work?**
Yes. [Ultimate Dominion](https://ultimatedominion.com) is multiplayer — you share the world with other players, trade on the marketplace, and can PvP in danger zones. All in a browser tab.

**What games run in a browser with no install?**
All games listed here run directly in a browser with no installation. Ultimate Dominion, A Dark Room, Candy Box 2, Melvor Idle, Universal Paperclips, Kittens Game, Wordle, and 2048 are all browser-native.

**What game looks least like a game?**
A Dark Room (just text on a black background), Universal Paperclips (looks like a plain HTML page), and [Ultimate Dominion](https://ultimatedominion.com) (looks like a dark-themed text website). All three could pass as work-related if someone glances at your screen.
